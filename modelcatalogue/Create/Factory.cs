...
//        public void NozzlePpoint(Direction direction, Position position, Size size, int number, NozzleConfig nozzleConfig) {
//            var ptca = ConnectingPTCA(direction.Z, position, size.Diameter, number, nozzleConfig);
//        }
...
//                    break;
//                case "NOZZ":
//                    Ppoint(element.Direction, element.Position, element.Size, number, element.NozzleConfig);
//                    break;
//                default: break;
//            }
//        }
